"""
Django settings for cold_glitter_42744 project.
...
ROOT_URLCONF = 'cold_glitter_42744.urls'
...
WSGI_APPLICATION = 'cold_glitter_42744.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "cold_glitter_42744 API",
    "DESCRIPTION": "API documentation for cold_glitter_42744 App",
    "VERSION": "v1",
}
